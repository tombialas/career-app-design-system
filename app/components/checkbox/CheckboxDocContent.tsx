    ...
    <div className="space-y-10">
      <header className="space-y-3">
        ...
        <p className="max-w-2xl text-[16px] leading-relaxed text-ds-text-secondary">
          Checkbox (Radix). size-5, rounded-md, and a border. Checked = bg-ds-primary-strong with a white icon.
        </p>
      </header>
      ...
      <section>
        ...
        <ul className="list-inside list-disc space-y-1 text-sm text-ds-text-secondary">
          ...
          <li><strong>Icon:</strong> Lucide Check, white in the checked state</li>
        </ul>
      </section>
    </div>
  );
